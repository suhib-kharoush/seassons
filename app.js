...
var country = ''
if (order === 'greece') {country ='<img src="images/greece.jpg" />';
    
}else if (order === 'turkey') {country ='<img src="images/turkey.jpg" />"';
    
}else if (order === 'croatia') {country ='<img src="images/croatia.jpg" />';
